...
@Component({
    selector: 'as-admin-list-payments',
    templateUrl: 'app/admin/templates/admin_list_payments.html',
    styleUrls: [
        'app/admin/styles/admin_list_payments.css'
    ]
})

export class AdminListPaymentsComponent implements OnInit {
