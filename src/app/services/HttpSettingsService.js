...
var HttpSettingsService = (function () {
    ...
    HttpSettingsService.prototype.getUnauthorizedHeaders = function () {
        ...
        return new http_1.Headers(headersObj);
    };
    ...
    HttpSettingsService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [SessionService_1.SessionService, SettingsService_1.SettingsService])
    ], HttpSettingsService);
    return HttpSettingsService;
}());
exports.HttpSettingsService = HttpSettingsService;
